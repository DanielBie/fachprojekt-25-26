...
static void filterHorizontally(uint8_t *output, const uint8_t *input, const int width, const int height, const int *kernel, const int radius, const int shift) {
    const int rounding = 1 << (shift - 1);
...
void blur(uint8_t *output, const uint8_t *input, const int width, const int height, uint8_t *temp, bool baseline) {
